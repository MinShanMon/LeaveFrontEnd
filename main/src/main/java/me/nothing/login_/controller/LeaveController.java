...
public class LeaveController {
    ...
    public String createNewLeave(@ModelAttribute("leave") @Valid Leave leave, BindingResult result,
        ...
        try {
            ...
            redirectAttrs.addFlashAttribute("error", error.substring(delimiterIndex));
